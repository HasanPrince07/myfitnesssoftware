                    ...
                    <div className="row justify-content-center">
                        <div className="account-div col-md-11 col-sm-9 col-10 row align-items-center shadow-sm rounded-3 p-0">
                            <div className="col-md-6 col-12 position-relative img-container-box p-0">
                                <img className="account-img object-fit-cover" src="media/images/signup_wall.jpg" alt="signin-wall" />
                                <div className="d-flex align-items-center position-absolute top-0 bottom-0 start-0 end-0 px-xl-5 px-4">
                                    ...
                                    />
                                    <h2 className="text-white img-container-text ms-3 m-0">Smart solutions for your fitness business.</h2>
                                </div>
                            </div>
                            <div className="col-md-6 col-12 px-lg-5 px-sm-4 px-3 py-lg-0 py-4">
                                <h2 className="text-center text-uppercase fw-bold mb-1">sign up</h2>
                                <p className="text-center text-muted mb-4">Get started with MyFitness Software account</p>
                                <form onSubmit={handleForm}>
                                    ...
                                    <label className={`form-label ${showEmailError ? "mt-1" : "mt-3"}`}>Set Password</label>
                                    ...
                                    <div className="d-flex mt-4">
                                        <button type="submit" disabled={loading} className="btn text-uppercase shadow-none form-control fw-bold ">{loading ? <><div className="spinner mx-auto"></div></> : "create account"}</button>
                                    </div>
                                    <p className="d-flex justify-content-center mt-3 mb-md-0 mb-3">Already have an account?<Link to="/signin" className="text-decoration-none ps-1">Signin</Link></p>
                                </form>
                            </div>
                        </div>
                    </div>
